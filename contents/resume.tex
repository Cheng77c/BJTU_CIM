\begin{ResumePublications}
	\begin{ResumeList}
		...
		\begin{PublicationsList}
			...
			\item (第一作者，EI)基于NSGA-II的盾构管片智能化设计系统\hspace{0em}[J].铁道工程学报,2025.
			\item (第一作者，EI)基于 SVR-OK 算法的三维地质建模方法\hspace{0em}[J].隧道建设,2025.
		...
		\begin{PublicationsList}
			...
			\item （国际标准，联合主编，已发布）IEC63302-1  Intelligent operations center for Smart Cities–Part 1 : High Level Analysis.
			\item （国际标准，联合主编，已发布）ISO 37176  Smart community infrastructure—Responsiveness assessment and maturity model.
			\item （国际标准，主编，编制中）IEC63302-2  Intelligent operations center for Smart Cities–Part 2 : Use Case Analysis.
